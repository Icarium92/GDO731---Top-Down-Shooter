...
public class ObjectPool : MonoBehaviour
{
    ...
    [SerializeField] private GameObject bulletPrefab; // New: Drag your enemy bullet prefab here
    ...
    private void Start()
    {
        ...
        InitializeNewPool(bulletPrefab); // New: Pre-initialize bullets to avoid runtime issues
    }
